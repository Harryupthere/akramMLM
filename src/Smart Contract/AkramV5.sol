...
contract OptimizedBinaryTree {
    ...
    function joinUser(
        ...
        address parentNode = findParentNode(_sponsor);
    ...
    function findParentNode(address _sponsor) public view returns (address) {
        ...
        return findParentNode(nodes[_sponsor].left);
    }

    function getChildNodes(address _sponsor)
        public
        view
        returns (address leftChild, address rightChild)
    {
        require(nodes[_sponsor].exists, "Sponsor does not exist");
        ...
        returns (EarningsData memory)
    {
        ...
        (leftAmount, rightAmount) = getMatchingData(
            leftUsers,
            rightUsers
        );
    ...
    function getAllChildNodesWithData(address _sponsor)
        public
        view
